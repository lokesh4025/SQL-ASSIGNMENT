...
-- 1 identify the primary key and and foriegn in maven movies db. discuss the difference 

select 
    table_name, column_name
FROM
    information_schema.key_ column_usage
WHERE
    contraint_name = 'primary'
        ...
        -- foreign key: establishes relationship between tables by referncing the primary key of another table.it can contain null values also
        ...
        select film_id ,title,rental_duraion from film where rental_duration >5;
